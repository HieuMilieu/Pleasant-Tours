...
<body>
    ...
    <div id="right-panel" class="right-panel">
        <div class="container">
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" href="../tour_category/tourList.php">Quản Lý Danh Mục</a>
                </li>
                <li class="nav-item">
	...
	<div class="container">
		...
		<div class="panel-heading">
                    <h2 class="text-center">Quản Lý Sản Phẩm Tour</h2>
		</div>
			...
			<tbody>
                        ...
                        foreach ($productList as $item) {
                            echo '<tr>
                                ...
                                <td>
                                    <a href="addTourProduct.php?id='.$item['id'].'"><button class="btn btn-warning">Sửa</button></a>
                                </td>
                                <td>
