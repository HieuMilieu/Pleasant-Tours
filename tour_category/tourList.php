...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="../blog/blogList.php" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div id="right-panel" class="right-panel">
        <div class="container">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../Tour/tourProduct.php">Quản Lý Sản Phẩm</a>
                </li>
            </ul>
	...
	<div class="container">
		...
		<div class="panel-heading">
                    <h2 class="text-center">Quản Lý Danh Mục Tour</h2>
		</div>
		<div class="panel-body">
			...
			<tbody>
                        ...
                        $sql          = 'select * from tour_category where 1 limit '.$firstIndex.', '.$limit;
                        $categoryList = executeResult($sql);
                        
                        $sql            = 'select count(id) as total from tour_category';
                        ...
                        foreach ($categoryList as $item) {
                            echo '<tr>
                                ...
                                <td>'.$item['name'].'</td>
                                <td>
                                    <a href="addTourCategory.php?id='.$item['id'].'"><button class="btn btn-warning">Sửa</button></a>
                                </td>
                                <td>
