...
?>
        ...
        <div>
            ...
            <div class="container">
                <div class="image">
                    <img src="img/bar.jpg" alt="Snow" id="bar">
                    <div class="centered">
                        <p class="title">Điểm đến phổ biến</p>
                    </div>
                </div> 
                
                <div class="card-deck mb-3">
<?php
    $sql         = 'select tour.id, tour.name, tour.place, tour.price, tour.duration, tour.thumbnail, tour.updated_at, tour_category.name as category_name from tour left join tour_category on tour.id_category = tour_category.id where tour_category.id != 10 ORDER BY RAND() LIMIT 3';
    ...
    echo '<div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                ...
                <a href="../Tour/tour/details.php?id='.$item['id'].'">
            ...
            <div class="container">
                <div class="image">
                    <img src="img/bar.jpg" alt="Snow" id="bar">
                    <div class="centered">
                        <p class="title">Du lịch trong nước</p>
                    </div>
                </div>     
    ...
    echo '<div class="card mb-4 shadow-sm">
            ...
            <div class="container">
                <div class="image">
                    <img src="img/bar.jpg" alt="Snow" id="bar">
                    <div class="centered">
                        <p class="title">Du lịch nước ngoài</p>
                    </div>
                </div>
